    ...
    return (
      ...
      <div className='property-img-container'>
          <div className='img-item'>
              <img src={images[0].url} className='images' style={{ borderTopLeftRadius: "18px", borderBottomLeftRadius: "10px" }}
              alt='property-1'
              />
          </div>
          <div className='images' src={images[1].url} alt='property'></div>
          <div className='images' src={images[2].url} alt='property'></div>
          <div className='images' src={images[3].url} alt='property'></div>
          <div >
